...
$pdf->Cell("","10","REPORT OF MAINTENANCE UNIT","","1","C");
...
$pdf->Cell(37 ,"10","Cause/Damage","1","0","C");
$pdf->Cell(30 ,"10","Remarks","1","1","C");
$pdf->SetFont('Courier','',8);
$id = $_GET['id'];
/** @var connection_name $conn */
$sql = $conn->query("select * from tbl_maintenance where id = ".$id);
$data = $sql->fetch_assoc();
$pdf->Cell(32,"10",$data['date_acquired'],"1","0","C");
$pdf->MultiCell(64 ,'5',$data['particulars_articles'] . "|". " Qty: ". $data['qty'] . "|Serial Number: ".$data['serial_number'],"1","L","");
$pdf->SetXY($pdf->GetX() + 96,$pdf->GetY() - 10);
$pdf->Cell(25 ,"10",$data['total_cost'],"1","0","C");
$pdf->Cell(37 ,"10",$data['status_damage'],"1","0","C");
