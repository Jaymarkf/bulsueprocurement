...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12" id="content">
            <div class="row-fluid">
                <div class="pull-left">
                    <h3><i class="icon icon-large icon-book text-success"></i> View Inventory Reports</h3>
...
<div class="container-fluid">
    ...
    <div class="text-center">
        <h4>View <span style="color:deepskyblue;font-family: 'Helvetica Neue', 'Helvetica'">Inventory Reports</span></h4>
    </div>
    <?php
    include('view_inventory_reports_table.php');
    include('footer.php');
    ?>
</div>
