<div class="navbar navbar-fixed-top navbar-inverse">
	<div class="navbar-inner">
		<div class="container-fluid">
				...
				<ul class="nav pull-left">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li class="divider"></li>
							<li>
								<!-- <a tabindex="-1" href="app_pr_approved.php<?php echo '?year='.$row['Year']; ?>" class="jkl"><img src="../images/buttons/pr.png" width="10%"> Purchase Request </a> -->
								<a tabindex="-1" href="app_pr_approved.php" class="jkl"><img src="../images/buttons/pr.png" width="10%"> Purchase Request </a>
							</li>
							<li>
								<a tabindex="-1" href="quotation.php" class="jkl"><img src="../images/buttons/rfq.png" width="10%"> Price Quotation </a>
							</li>
							<li>
								<a tabindex="-1" href="bac-res-main.php" class="jkl"><i class="icon-certificate icon-large"></i> BAC Resolution </a>
							</li>
							<li>
								<a tabindex="-1" href="app_po_approved.php" class="jkl"><img src="../images/buttons/po.png" width="10%"> Purchase Order/Contract </a>
							</li>
							<li>
								<a tabindex="-1" href="under-construction.php" class="jkl"><img src="../images/buttons/iaa.png" width="10%"> Inspection and<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Acceptance </a>
							</li>
						</ul>
					</li>
				</ul>
				...
				<ul class="nav pull-left">
					<li class="dropdown">
						...
						<ul class="dropdown-menu"> -->
							<!--  <li><a class="jkl" tabindex="-1" href="#">Profile</a></li> -->
			<!-- 			<li>
								<a tabindex="-1" href="activity_log.php" class="jkl"><i class="icon-user icon-large"></i> Activity Log</a>
							</li>
						</ul>
					</li>
				</ul>
			...
			<span class="brand" href="#">BULSU e-PROCUREMENT v1.0</span>
			
			<div id="coll" class="nav-collapse collapse">
				<ul class="nav pull-right">
					<li class="dropdown">
						<a href="#"><i class="icon-hdd icon-large"></i>Administrator CPanel</a>
					</li>
					...
					<li class="dropdown"> 
						<a href="#" id="name123" role="button" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-user icon-large">
							</i><?php echo $row['firstname']." ".$row['lastname'];  ?> <i class="caret"></i></a>
						<ul class="dropdown-menu">
							<!--  <li><a class="jkl" tabindex="-1" href="#">Profile</a></li> -->
							<li>
								<a tabindex="-1" href="password-change.php" class="jkl">Change Password</a>
							</li>
							<li class="divider"></li>
