                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                             		<?php 
							$user_query = mysql_query("SELECT * FROM users WHERE level='user' OR level='administrator'")or die(mysql_error());
                            ...
                            <div class="block-content collapse in">
								...
								<form action="" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
											<?php
												$user_query1 = mysql_query("SELECT * FROM users WHERE level='user' OR level='administrator' ORDER BY user_id DESC")or die(mysql_error());
