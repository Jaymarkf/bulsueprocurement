                ...
                <div class="span12" id="content">
                     <div class="row-fluid">
						...
						<?php
							...
							$query2= mysql_query("select * from tbl_ppmp WHERE Year = $Year AND EndUserUnit='$id' AND Status = 'Completed' AND BO_PPMP_Status = 'Approved'")or die(mysql_error());
							$count2 = mysql_num_rows($query2);
						?>
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><img src="../images/buttons/ppmp.png" width="5%"> APPROVED Project Procurement Management Plan - <span class="badge badge-warning">YEAR <?php echo $Year; ?></span></div>
