                ...
                <div class="span12" id="content">
                     <div class="row-fluid">
						...
						<?php
							...
							//$query2 = mysql_query("SELECT * FROM tbl_ppmp WHERE Year = $Year AND Status = 'Completed' AND BO_PPMP_Status='Approved' AND PU_PPMP_Status='Approved' GROUP BY itemdetailDesc")or die(mysql_error());
