<div class="row-fluid">
	...
	<div class="block">
		<div class="navbar navbar-inner block-header">
			<div class="muted pull-left"><i class="icon-plus-sign icon-large"></i> Add Item Category</div>
		</div>
...
//if found reject the saving of users
	$query = "SELECT * FROM tbl_item_category WHERE itemCatDesc='$icDesc'";
...
?>
	...
	$.ajax({
			success: function(html){
				$.jGrowl("The category already exists.  Please try again...  ", { header: 'FAILED' });
				var delay = 6000;
				setTimeout(function(){ window.location = 'item-category.php'  }, delay);
			}
		});
