					...
					<div class="span12" id="content" style="background-color: #f9f9f9; padding:10px; border:5px solid #f1f1f1; box-shadow: 0px 0px 10px #000">
						...
						<div class="row-fluid">
							<div class="pull-left">
								...
								<a href="app_pr_approved-cancel.php<?php echo '?id='.$PR; ?>" name="cancel" title="Cancel new purchase request" id="cancel" data-placement="top" class="btn btn-danger"><i class="icon-save icon-large"></i> Cancel </a>
									<script type="text/javascript">
										$(document).ready(function(){
											$('#cancel').tooltip('show');
											$('#cancel').tooltip('hide');
