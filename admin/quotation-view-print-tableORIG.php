						...
						<div class="span12" id="content">
							<div class="row-fluid">
								...
								<div class="pull-right">
									<?php
										$item = $itemID;
										echo '<a href="quotation-view-print.php?item='.$item.'" title="Print Preview" id="back" data-placement="top" class="btn btn-success"><i class="icon-print icon-large"></i> Preview </a>';
									?>
										<script type="text/javascript">
											$(document).ready(function(){
												$('#back').tooltip('show');
									...
									<tbody>
										...
										?>
											<tr>
												...
												<td width="5" style="text-align:right;"><?php echo $row['unitPrice']; ?></td>
												<td width="5" style="text-align:right;"><?php echo $row['extPrice']; ?></td>
											</tr>
										<?php }; ?>
									</tbody>
								</table>
