							...
							<div class="block-content collapse in">
								...
								<form method="POST">
									...
									<div class="span12"  id="content">
										...
										<a href="ppmp.php" data-placement="right" title="Cancel item details UPDATE" id="cancel" name="cancel" class="btn btn-danger"><i class="icon-undo icon-large"></i> CANCEL </a>
											<script type="text/javascript">
											$(document).ready(function(){
												$('#cancel').tooltip('show');
												$('#cancel').tooltip('hide');
...
if (isset($_POST['saveUPDATE'])){
	...
	`Nov`='$Nov',`Dec`='$Dec',`TotalQty`='$TQtyMonth',`TotalAmount`='$TotalAmount',`Priority`='$Priority',`Remarks`='$Rem' WHERE ppmpID = '$prodID'")or die(mysql_error());
...
<script>
	$.ajax({
		success: function(html){
			...
			var delay = 1500;
			setTimeout(function(){ window.location = 'ppmp.php'  }, delay);
		}
	});
</script>
<?php
