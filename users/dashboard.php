    ...
    <body >
        ...
        <div class="container-fluid" id="">
			...
			<?php
				...
				//$query1= mysql_query("select * from tbl_ppmp WHERE Year = '$Year' AND user_id='$session_id' AND Status = 'Pending' GROUP BY YEAR")or die(mysql_error());
								...
								<div class="navbar navbar-inner block-header">
									...
									<?php
										...
										if(isset($_POST['filter'])) {
											...
											$result = mysql_query("SELECT * FROM tbl_item_details WHERE itemcategoryID LIKE '%".$filter."%' OR itemdetailDesc LIKE '%".$filter."%' OR UnitOfMeasurement LIKE '%".$filter."%' or PriceCatalogue like '%$filter%'");
										} else {
											//$title = '<h2 class="title text-center">All Items</h2>';
											$result = mysql_query("SELECT * FROM tbl_item_details")or die(mysql_error());
										}
